...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        if ($this->isEmail($this->get('username'))) {
            ...
            if (! Auth::attempt(['email' => $this->get('username'), 'password' => $this->get('password')],  $this->get('remember') != null ? true : false)) {
            ...
            if (! Auth::attempt(['username' => $this->get('username'), 'password' => $this->get('password')], $this->get('remember') != null ? true : false)) {
                RateLimiter::hit($this->throttleKey());

...
class CourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Course::create([
            ...
            'max_age' => 24,
            'duration' => 60,
            'opens_on' => date(env('APP_DATETIME_FORMAT'), strtotime('next Thursday noon', strtotime('-4 week', time()))),
            'opens_until' => date(env('APP_DATETIME_FORMAT'), strtotime('next Thursday noon', strtotime('-3 week', time()))),
            'starts_on' => date(env('APP_DATETIME_FORMAT'), strtotime('2023-11-09 12:00:00')),
        ...
        Course::create([
            ...
            'max_age' => 24,
            'duration' => 60,
            'opens_on' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-4 week', time()))),
            'opens_until' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
            'starts_on' => date(env('APP_DATETIME_FORMAT'), strtotime('2023-11-07 12:00:00')),
            'status' => CourseStatusEnum::ACTIVE->name,
            'price' => 7500.00,
        ...
        Course::create([
            ...
            'opens_on' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-4 week', time()))),
            'opens_until' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
            'starts_on' => date(env('APP_DATETIME_FORMAT'), strtotime('2023-11-10 12:00:00')),
            'status' => CourseStatusEnum::ACTIVE->name,
            'price' => 7500.00,
            'created_at' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
            'updated_at' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
        ...
        Course::create([
            'teacher_id' => $teacherId,
            'title' => 'Sat 12pm',
            'description' => 'A Saturday course at 12:00',
            'quota' => 10,
            'capacity' => 4,
            'min_age' => 12,
            'max_age' => 24,
            ...
            'opens_on' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-4 week', time()))),
            'opens_until' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
            'starts_on' => date(env('APP_DATETIME_FORMAT'), strtotime('2023-11-11 12:00:00')),
            'status' => CourseStatusEnum::ACTIVE->name,
            'price' => 7500.00,
            'created_at' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),
            'updated_at' => date(env('APP_DATETIME_FORMAT'), strtotime('next Tuesday noon', strtotime('-3 week', time()))),

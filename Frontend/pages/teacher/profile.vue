            ...
            <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
                ...
                <div class="col-span-4 sm:col-span-9">
                    <div class="bg-white shadow rounded-lg p-6">
                        ...
                        <p class="text-gray-700">Lastname : {{ user.value.last_name }} </p>
...
const { data: courseResponse, error: courseError } = await useApiFetch(`api/teacher/getTeacherCourses/${user.value.id}`, {});

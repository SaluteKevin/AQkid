        ...
        <div class="grid grid-cols-4 sm:grid-cols-12 gap-6 px-4">
            ...
            <div class="col-span-4 sm:col-span-9">
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <p class="text-gray-700">Age : {{new Date().getFullYear() - new Date(student.birthdate).getFullYear()}} </p>
                    <hr class="my-6 border-t border-gray-300">
                    ...
                    <!-- <div class="mb-3 shadow-xl border rounded-2xl p-4" v-for="course in teacher.courses" :key="course.id">

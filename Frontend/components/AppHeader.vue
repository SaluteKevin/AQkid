    ...
    <nav class="z-10 w-full lg:border-transparent bg-gray-100 px-16">
        <div>
            <div class="flex flex-wrap items-center justify-between gap-6 py-2">
                ...
                <div class="space-x-4">
                    <NuxtLink class="py-2 px-4 text-white font-semibold rounded-md bg-cyan-900" to="/auths/login">
                    Login
                    </NuxtLink>
                    <NuxtLink class="py-2 px-4 text-white font-semibold rounded-md bg-orange-500" to="/auths/register">
                    Register
                    </NuxtLink>

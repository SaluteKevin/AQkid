        ...
        <div class = "flex-none h-full text-center flex items-center justify-center">
                ...
                <div v-click-outside="clickOutside" class="relative">
                        ...
                        <div class="px-2 py-2 bg-white rounded-md shadow dark-mode:bg-gray-800">
                            ...
                            <button v-on:click="logout" class="flex items-center justify-center gap-5 w-full px-4 py-2 mt-2 text-sm font-semibold bg-transparent rounded-lg text-red-500 md:mt-0 hover:text-gray-900 hover:text-red-800 focus:text-gray-900 hover:bg-red-200 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
